...
EOF;
        ...
        $node
            ...
            ->children()
            ->scalarNode('page')
            ->defaultValue('EcommerceBundle\\PageBundle\\Entity\\Page')
            ->end()
            ->scalarNode('snapshot')
            ->defaultValue('EcommerceBundle\\PageBundle\\Entity\\Snapshot')
            ->end()
            ->scalarNode('block')
            ->defaultValue('EcommerceBundle\\PageBundle\\Entity\\Block')
            ->end()
            ->scalarNode('site')
            ->defaultValue('EcommerceBundle\\PageBundle\\Entity\\Site')
            ->end()
            ->end()
            ->end()
