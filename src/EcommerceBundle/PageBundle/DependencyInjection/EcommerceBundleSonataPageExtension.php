...
namespace EcommerceBundle\PageBundle\DependencyInjection;
 ...
 */
class EcommerceBundleSonataPageExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $configs = [ $this->bundleConfigs['EcommerceBundleSonataPageBundle'] ];
        $containerParent = $configs['0'];
        $extensionConfig = $containerParent->getExtensionConfig('sonata_page');
    ...
    public function prepend(ContainerBuilder $container)
    {
        ...
        if (isset($bundles['SonataPageBundle'])){
            $this->bundleConfigs['EcommerceBundleSonataPageBundle'] = $container;
        }
        ...
        if (isset($bundles['SonataPageBundle'])){
            ...
            unset($currentClassPropertyValue['sonata_page']);
