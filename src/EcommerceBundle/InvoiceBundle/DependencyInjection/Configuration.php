...
namespace EcommerceBundle\InvoiceBundle\DependencyInjection;
        ...
        $node
            ->children()
                ->arrayNode('class')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('invoice')->defaultValue('EcommerceBundle\\InvoiceBundle\\Entity\\Invoice')->end()
                        ->scalarNode('invoice_element')->defaultValue('EcommerceBundle\\InvoiceBundle\\Entity\\InvoiceElement')->end()
