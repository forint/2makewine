 ...
 */
class EcommerceBundleSonataProductExtension extends Extension implements PrependExtensionInterface
{
    /**
     * @var array
     */
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $pool->addMethodCall('__hack', $this->bundleConfigs['EcommerceBundleSonataProductBundle']['products']);
    ...
    public function prepend(ContainerBuilder $container)
    {
        ...
        if (isset($bundles['SonataProductBundle'])){
            $this->bundleConfigs['EcommerceBundleSonataProductBundle'] = current($container->getExtensionConfig('sonata_product'));
        }
        ...
        if (isset($bundles['SonataProductBundle'])){
            ...
            unset($currentClassPropertyValue['sonata_product']);
