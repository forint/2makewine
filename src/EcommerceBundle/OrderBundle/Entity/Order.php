 ...
 * @ORM\Entity(repositoryClass="EcommerceBundle\OrderBundle\Repository\OrderRepository")
 */
class Order extends BaseOrder
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Customer", inversedBy="orders", cascade={"ALL"})
     * @ORM\JoinTable(name="customer__order",
     *      joinColumns={@ORM\JoinColumn(name="customer_id", referencedColumnName="id")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="order_id", referencedColumnName="id", unique=true, onDelete="CASCADE")}
     *      )
     */
    protected $customer;
