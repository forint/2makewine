...
class CellarStepAdmin extends AbstractAdmin
{
...
//        $collection->clearExcept(['create','edit', 'list']);
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $path = $helper->asset($fieldStep, 'previewFile', CellarStep::class);
...
//                                'attr' => ['class' => 'ckeditor', 'style' => 'resize: vertical; min-height: 100px;  ']
    ...
    {
        return $object instanceof CellarStep
            ? $object->getDescription()
            : 'CellarStep'; // shown in the breadcrumb on the create view
    }
}
