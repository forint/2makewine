...
use AppBundle\Entity\StepDecide;
...
class FieldStepDecideAdmin extends AbstractAdmin
{
...
//        $collection->clearExcept(['create','edit', 'list']);
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add('stepPrice',null, array('global_search' => true), null, array())
            ->add('isStepGratis',null, array('global_search' => true), null, array());
    }
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $path = $helper->asset($stepDecide, 'previewFile', FieldStepDecide::class);
...
//                'required_locales' => ['en'],
            ...
            ->add('isStepGratis', 'sonata_type_choice_field_mask', [
                'choices' => FieldStepDecide::getStepType(),
                'map' => [
                    false => ['stepPrice'],
                ],
                'required' => false,
    ...
    {
        return $object instanceof FieldStepDecide
            ? $object->getTitle()
            : 'FieldStepDecide'; // shown in the breadcrumb on the create view
    }
}
